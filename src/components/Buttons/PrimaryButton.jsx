...
const PrimaryButton = ({href, text ,border}) => {
  return (
    <div>
        <Link
          href={href} 
          className={`mt-8 max-sm:mt-4 flex items-center min-w-[12vw] justify-between gap-3 p-1.5 py-1 rounded-full bg-white text-[#111111] text-xs font-light uppercase tracking-wide transition-all duration-300 hover:bg-[#111111] hover:text-white group ${border ? 'border border-black' : ' border-none'} `}
        >
          ...
          <div className="size-[3vw] p-2 max-sm:size-[8vw] rounded-full  overflow-hidden bg-[#111111] group-hover:bg-white transition-all duration-300">
